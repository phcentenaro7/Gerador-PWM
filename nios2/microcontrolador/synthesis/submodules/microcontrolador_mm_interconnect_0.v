...
module microcontrolador_mm_interconnect_0 (
		...
		output wire [1:0]  pinos_entrada_s1_address,                //                  pinos_entrada_s1.address
		input  wire [31:0] pinos_entrada_s1_readdata,               //                                  .readdata
		output wire [1:0]  pinos_saida_s1_address,                  //                    pinos_saida_s1.address
		output wire        pinos_saida_s1_write,                    //                                  .write
		input  wire [31:0] pinos_saida_s1_readdata,                 //                                  .readdata
		output wire [31:0] pinos_saida_s1_writedata,                //                                  .writedata
		output wire        pinos_saida_s1_chipselect,               //                                  .chipselect
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire   [6:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> sys_timer_s1_agent:cp_channel
	...
	wire  [31:0] pinos_saida_s1_agent_m0_readdata;                                            // pinos_saida_s1_translator:uav_readdata -> pinos_saida_s1_agent:m0_readdata
	wire         pinos_saida_s1_agent_m0_waitrequest;                                         // pinos_saida_s1_translator:uav_waitrequest -> pinos_saida_s1_agent:m0_waitrequest
	wire         pinos_saida_s1_agent_m0_debugaccess;                                         // pinos_saida_s1_agent:m0_debugaccess -> pinos_saida_s1_translator:uav_debugaccess
	wire  [20:0] pinos_saida_s1_agent_m0_address;                                             // pinos_saida_s1_agent:m0_address -> pinos_saida_s1_translator:uav_address
	wire   [3:0] pinos_saida_s1_agent_m0_byteenable;                                          // pinos_saida_s1_agent:m0_byteenable -> pinos_saida_s1_translator:uav_byteenable
	wire         pinos_saida_s1_agent_m0_read;                                                // pinos_saida_s1_agent:m0_read -> pinos_saida_s1_translator:uav_read
	wire         pinos_saida_s1_agent_m0_readdatavalid;                                       // pinos_saida_s1_translator:uav_readdatavalid -> pinos_saida_s1_agent:m0_readdatavalid
	wire         pinos_saida_s1_agent_m0_lock;                                                // pinos_saida_s1_agent:m0_lock -> pinos_saida_s1_translator:uav_lock
	wire  [31:0] pinos_saida_s1_agent_m0_writedata;                                           // pinos_saida_s1_agent:m0_writedata -> pinos_saida_s1_translator:uav_writedata
	wire         pinos_saida_s1_agent_m0_write;                                               // pinos_saida_s1_agent:m0_write -> pinos_saida_s1_translator:uav_write
	wire   [2:0] pinos_saida_s1_agent_m0_burstcount;                                          // pinos_saida_s1_agent:m0_burstcount -> pinos_saida_s1_translator:uav_burstcount
	wire         pinos_saida_s1_agent_rf_source_valid;                                        // pinos_saida_s1_agent:rf_source_valid -> pinos_saida_s1_agent_rsp_fifo:in_valid
	wire  [97:0] pinos_saida_s1_agent_rf_source_data;                                         // pinos_saida_s1_agent:rf_source_data -> pinos_saida_s1_agent_rsp_fifo:in_data
	wire         pinos_saida_s1_agent_rf_source_ready;                                        // pinos_saida_s1_agent_rsp_fifo:in_ready -> pinos_saida_s1_agent:rf_source_ready
	wire         pinos_saida_s1_agent_rf_source_startofpacket;                                // pinos_saida_s1_agent:rf_source_startofpacket -> pinos_saida_s1_agent_rsp_fifo:in_startofpacket
	wire         pinos_saida_s1_agent_rf_source_endofpacket;                                  // pinos_saida_s1_agent:rf_source_endofpacket -> pinos_saida_s1_agent_rsp_fifo:in_endofpacket
	wire         pinos_saida_s1_agent_rsp_fifo_out_valid;                                     // pinos_saida_s1_agent_rsp_fifo:out_valid -> pinos_saida_s1_agent:rf_sink_valid
	wire  [97:0] pinos_saida_s1_agent_rsp_fifo_out_data;                                      // pinos_saida_s1_agent_rsp_fifo:out_data -> pinos_saida_s1_agent:rf_sink_data
	wire         pinos_saida_s1_agent_rsp_fifo_out_ready;                                     // pinos_saida_s1_agent:rf_sink_ready -> pinos_saida_s1_agent_rsp_fifo:out_ready
	wire         pinos_saida_s1_agent_rsp_fifo_out_startofpacket;                             // pinos_saida_s1_agent_rsp_fifo:out_startofpacket -> pinos_saida_s1_agent:rf_sink_startofpacket
	wire         pinos_saida_s1_agent_rsp_fifo_out_endofpacket;                               // pinos_saida_s1_agent_rsp_fifo:out_endofpacket -> pinos_saida_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> pinos_saida_s1_agent:cp_valid
	wire  [96:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> pinos_saida_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // pinos_saida_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> pinos_saida_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> pinos_saida_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> pinos_saida_s1_agent:cp_endofpacket
	wire  [31:0] pinos_entrada_s1_agent_m0_readdata;                                          // pinos_entrada_s1_translator:uav_readdata -> pinos_entrada_s1_agent:m0_readdata
	wire         pinos_entrada_s1_agent_m0_waitrequest;                                       // pinos_entrada_s1_translator:uav_waitrequest -> pinos_entrada_s1_agent:m0_waitrequest
	wire         pinos_entrada_s1_agent_m0_debugaccess;                                       // pinos_entrada_s1_agent:m0_debugaccess -> pinos_entrada_s1_translator:uav_debugaccess
	wire  [20:0] pinos_entrada_s1_agent_m0_address;                                           // pinos_entrada_s1_agent:m0_address -> pinos_entrada_s1_translator:uav_address
	wire   [3:0] pinos_entrada_s1_agent_m0_byteenable;                                        // pinos_entrada_s1_agent:m0_byteenable -> pinos_entrada_s1_translator:uav_byteenable
	wire         pinos_entrada_s1_agent_m0_read;                                              // pinos_entrada_s1_agent:m0_read -> pinos_entrada_s1_translator:uav_read
	wire         pinos_entrada_s1_agent_m0_readdatavalid;                                     // pinos_entrada_s1_translator:uav_readdatavalid -> pinos_entrada_s1_agent:m0_readdatavalid
	wire         pinos_entrada_s1_agent_m0_lock;                                              // pinos_entrada_s1_agent:m0_lock -> pinos_entrada_s1_translator:uav_lock
	wire  [31:0] pinos_entrada_s1_agent_m0_writedata;                                         // pinos_entrada_s1_agent:m0_writedata -> pinos_entrada_s1_translator:uav_writedata
	wire         pinos_entrada_s1_agent_m0_write;                                             // pinos_entrada_s1_agent:m0_write -> pinos_entrada_s1_translator:uav_write
	wire   [2:0] pinos_entrada_s1_agent_m0_burstcount;                                        // pinos_entrada_s1_agent:m0_burstcount -> pinos_entrada_s1_translator:uav_burstcount
	wire         pinos_entrada_s1_agent_rf_source_valid;                                      // pinos_entrada_s1_agent:rf_source_valid -> pinos_entrada_s1_agent_rsp_fifo:in_valid
	wire  [97:0] pinos_entrada_s1_agent_rf_source_data;                                       // pinos_entrada_s1_agent:rf_source_data -> pinos_entrada_s1_agent_rsp_fifo:in_data
	wire         pinos_entrada_s1_agent_rf_source_ready;                                      // pinos_entrada_s1_agent_rsp_fifo:in_ready -> pinos_entrada_s1_agent:rf_source_ready
	wire         pinos_entrada_s1_agent_rf_source_startofpacket;                              // pinos_entrada_s1_agent:rf_source_startofpacket -> pinos_entrada_s1_agent_rsp_fifo:in_startofpacket
	wire         pinos_entrada_s1_agent_rf_source_endofpacket;                                // pinos_entrada_s1_agent:rf_source_endofpacket -> pinos_entrada_s1_agent_rsp_fifo:in_endofpacket
	wire         pinos_entrada_s1_agent_rsp_fifo_out_valid;                                   // pinos_entrada_s1_agent_rsp_fifo:out_valid -> pinos_entrada_s1_agent:rf_sink_valid
	wire  [97:0] pinos_entrada_s1_agent_rsp_fifo_out_data;                                    // pinos_entrada_s1_agent_rsp_fifo:out_data -> pinos_entrada_s1_agent:rf_sink_data
	wire         pinos_entrada_s1_agent_rsp_fifo_out_ready;                                   // pinos_entrada_s1_agent:rf_sink_ready -> pinos_entrada_s1_agent_rsp_fifo:out_ready
	wire         pinos_entrada_s1_agent_rsp_fifo_out_startofpacket;                           // pinos_entrada_s1_agent_rsp_fifo:out_startofpacket -> pinos_entrada_s1_agent:rf_sink_startofpacket
	wire         pinos_entrada_s1_agent_rsp_fifo_out_endofpacket;                             // pinos_entrada_s1_agent_rsp_fifo:out_endofpacket -> pinos_entrada_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> pinos_entrada_s1_agent:cp_valid
	wire  [96:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> pinos_entrada_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                       // pinos_entrada_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> pinos_entrada_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> pinos_entrada_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> pinos_entrada_s1_agent:cp_endofpacket
	...
	wire         pinos_saida_s1_agent_rp_valid;                                               // pinos_saida_s1_agent:rp_valid -> router_007:sink_valid
	wire  [96:0] pinos_saida_s1_agent_rp_data;                                                // pinos_saida_s1_agent:rp_data -> router_007:sink_data
	wire         pinos_saida_s1_agent_rp_ready;                                               // router_007:sink_ready -> pinos_saida_s1_agent:rp_ready
	wire         pinos_saida_s1_agent_rp_startofpacket;                                       // pinos_saida_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pinos_saida_s1_agent_rp_endofpacket;                                         // pinos_saida_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         pinos_entrada_s1_agent_rp_valid;                                             // pinos_entrada_s1_agent:rp_valid -> router_008:sink_valid
	wire  [96:0] pinos_entrada_s1_agent_rp_data;                                              // pinos_entrada_s1_agent:rp_data -> router_008:sink_data
	wire         pinos_entrada_s1_agent_rp_ready;                                             // router_008:sink_ready -> pinos_entrada_s1_agent:rp_ready
	wire         pinos_entrada_s1_agent_rp_startofpacket;                                     // pinos_entrada_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         pinos_entrada_s1_agent_rp_endofpacket;                                       // pinos_entrada_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         pinos_saida_s1_agent_rdata_fifo_src_valid;                                   // pinos_saida_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] pinos_saida_s1_agent_rdata_fifo_src_data;                                    // pinos_saida_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         pinos_saida_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_005:in_0_ready -> pinos_saida_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> pinos_saida_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> pinos_saida_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // pinos_saida_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> pinos_saida_s1_agent:rdata_fifo_sink_error
	wire         pinos_entrada_s1_agent_rdata_fifo_src_valid;                                 // pinos_entrada_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] pinos_entrada_s1_agent_rdata_fifo_src_data;                                  // pinos_entrada_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         pinos_entrada_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_006:in_0_ready -> pinos_entrada_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                           // avalon_st_adapter_006:out_0_valid -> pinos_entrada_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                            // avalon_st_adapter_006:out_0_data -> pinos_entrada_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                           // pinos_entrada_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                           // avalon_st_adapter_006:out_0_error -> pinos_entrada_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pinos_saida_s1_translator (
		.clk                    (clk_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pinos_saida_s1_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (pinos_saida_s1_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (pinos_saida_s1_agent_m0_read),            //                         .read
		.uav_write              (pinos_saida_s1_agent_m0_write),           //                         .write
		.uav_waitrequest        (pinos_saida_s1_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (pinos_saida_s1_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (pinos_saida_s1_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (pinos_saida_s1_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (pinos_saida_s1_agent_m0_writedata),       //                         .writedata
		.uav_lock               (pinos_saida_s1_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (pinos_saida_s1_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (pinos_saida_s1_address),                  //      avalon_anti_slave_0.address
		.av_write               (pinos_saida_s1_write),                    //                         .write
		.av_readdata            (pinos_saida_s1_readdata),                 //                         .readdata
		.av_writedata           (pinos_saida_s1_writedata),                //                         .writedata
		.av_chipselect          (pinos_saida_s1_chipselect),               //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pinos_entrada_s1_translator (
		.clk                    (clk_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pinos_entrada_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (pinos_entrada_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (pinos_entrada_s1_agent_m0_read),          //                         .read
		.uav_write              (pinos_entrada_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (pinos_entrada_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (pinos_entrada_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (pinos_entrada_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (pinos_entrada_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (pinos_entrada_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (pinos_entrada_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (pinos_entrada_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (pinos_entrada_s1_address),                //      avalon_anti_slave_0.address
		.av_readdata            (pinos_entrada_s1_readdata),               //                         .readdata
		.av_write               (),                                        //              (terminated)
		.av_read                (),                                        //              (terminated)
		.av_writedata           (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) pinos_saida_s1_agent (
		.clk                     (clk_clk_clk),                                     //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (pinos_saida_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (pinos_saida_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (pinos_saida_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (pinos_saida_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (pinos_saida_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (pinos_saida_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (pinos_saida_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (pinos_saida_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (pinos_saida_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (pinos_saida_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (pinos_saida_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (pinos_saida_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (pinos_saida_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (pinos_saida_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (pinos_saida_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (pinos_saida_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (pinos_saida_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (pinos_saida_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (pinos_saida_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (pinos_saida_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (pinos_saida_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (pinos_saida_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (pinos_saida_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (pinos_saida_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (pinos_saida_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (pinos_saida_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),               //                .error
		.rdata_fifo_src_ready    (pinos_saida_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pinos_saida_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (pinos_saida_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pinos_saida_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                     //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (pinos_saida_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pinos_saida_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pinos_saida_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pinos_saida_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pinos_saida_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pinos_saida_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pinos_saida_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pinos_saida_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pinos_saida_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pinos_saida_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) pinos_entrada_s1_agent (
		.clk                     (clk_clk_clk),                                       //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),           //       clk_reset.reset
		.m0_address              (pinos_entrada_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (pinos_entrada_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (pinos_entrada_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (pinos_entrada_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (pinos_entrada_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (pinos_entrada_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (pinos_entrada_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (pinos_entrada_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (pinos_entrada_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (pinos_entrada_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (pinos_entrada_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (pinos_entrada_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (pinos_entrada_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (pinos_entrada_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (pinos_entrada_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (pinos_entrada_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (pinos_entrada_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (pinos_entrada_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (pinos_entrada_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (pinos_entrada_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (pinos_entrada_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (pinos_entrada_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (pinos_entrada_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (pinos_entrada_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (pinos_entrada_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (pinos_entrada_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (pinos_entrada_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pinos_entrada_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (pinos_entrada_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pinos_entrada_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                       //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
		.in_data           (pinos_entrada_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pinos_entrada_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pinos_entrada_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pinos_entrada_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pinos_entrada_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pinos_entrada_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pinos_entrada_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pinos_entrada_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pinos_entrada_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pinos_entrada_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	microcontrolador_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (pinos_saida_s1_agent_rp_ready),           //      sink.ready
		.sink_valid         (pinos_saida_s1_agent_rp_valid),           //          .valid
		.sink_data          (pinos_saida_s1_agent_rp_data),            //          .data
		.sink_startofpacket (pinos_saida_s1_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (pinos_saida_s1_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microcontrolador_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (pinos_entrada_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (pinos_entrada_s1_agent_rp_valid),         //          .valid
		.sink_data          (pinos_entrada_s1_agent_rp_data),          //          .data
		.sink_startofpacket (pinos_entrada_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (pinos_entrada_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microcontrolador_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (pinos_saida_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (pinos_saida_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (pinos_saida_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	microcontrolador_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset),     // in_rst_0.reset
		.in_0_data      (pinos_entrada_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (pinos_entrada_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (pinos_entrada_s1_agent_rdata_fifo_src_ready), //         .ready
